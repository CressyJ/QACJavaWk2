	...
	public boolean printMap() {
		...
		for(int i = 0; i < 10; i++) {
			for(int j = 0; j < 10; j++) {
				...
				else if(ActorManager.getActorManager().npcInLocation(grid[i][j])) System.out.print(" N ");
				else if(ActorManager.getActorManager().actorInLocation(grid[i][j])) System.out.print(" * ");
				else{
